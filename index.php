...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-grey fixed fixed-top"
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color:white;"><b>Our Awesome Bank Facilities</b></h1>
                ...
                <div class="row">
                    <div class="col-lg">
                        <div
                            ...
                            <h6>Here, you can watch every customer of our bank.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
